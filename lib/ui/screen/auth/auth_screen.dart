...
class _SignUpPageState extends State<_SignUpPage> {
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      labelStyle: GoogleFonts.cairo(fontSize: 14.0),
                      helperText: localizations
                          .getLocalization("login_registration_helper_text"),
                      hintStyle: GoogleFonts.cairo(fontSize: 14.0),
                      filled: true),
                  validator: (value) {
                    if (value.isEmpty) {
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      helperStyle: GoogleFonts.cairo(fontSize: 14.0),
                      filled: true),
        ...
        builder: (context) {
          return AlertDialog(
            title: Text(localizations.getLocalization("error_dialog_title"),
                textScaleFactor: 1.0,
                style: GoogleFonts.cairo(color: Colors.black, fontSize: 20.0)),
            content: Text(
              text,
              textScaleFactor: 1.0,
            ),
  ...
  void register() {
    if (_formKey.currentState.validate()) {
      _bloc.add(RegisterEvent(_loginController.text.trim(), _emailController.text.trim(),
